...
namespace Encryptor.Platforms.Windows;

public static class CursorExtensions
{
    public static void SetCustomCursor(this Microsoft.Maui.Controls.VisualElement visualElement, CursorIcon cursor, IMauiContext? mauiContext)
    {
